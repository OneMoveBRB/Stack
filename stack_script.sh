...
source="g++ main.c src/stack.c src/stack_dump.c -o stack"

mode_flag="-D DEBUG"

flags=" \
-ggdb3 -std=c++17 -O0 -Wall -Wextra -Weffc++ -Waggressive-loop-optimizations -Wc++14-compat \
...
command="$source $mode_flag $flags"
